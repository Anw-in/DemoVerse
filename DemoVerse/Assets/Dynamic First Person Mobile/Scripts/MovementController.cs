...
namespace FirstPersonMobileTools.DynamicFirstPerson
{
    ...
    #region Class accessible field
        ...
        [HideInInspector] public bool Input_Action { get; set; }    // Add accessed through [Action button] in the scene
    ...
    #region Editor accessible field
        ...
        [SerializeField] private AudioClip m_ActionSound;       // Add action sfx
        ...
        { 
            ...
            Handle_Action();    // Add function button
        ...
        private void Handle_Crouch()
        {
            ...
            {
                Debug.Log("Crouch-H " + m_CrouchHeight + " Origin " + m_OriginalScale.y + " LocalScale " + transform.localScale.y);         //
            ...
            {
                Debug.Log("Stand" + m_OriginalScale.y);     //
        ...
        private void Handle_Action()    // Add function button
        {
            if (Input_Action)
            {
                PlaySound(m_ActionSound);



                //   m_MovementDirection.y = m_JumpForce;
                if (m_ActionSound != null) PlaySound(m_ActionSound);
           }
        }
