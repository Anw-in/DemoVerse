...
namespace FirstPersonMobileTools.DynamicFirstPerson
{
    ...
    public class nonMobileInput : MonoBehaviour {
        ...
        [SerializeField] private KeyCode ActionInput;   // Add
        ...
        private void Update() {
            ...
            if (Input.GetKeyDown(ActionInput))                  // Add button Action
                movementController.Input_Action = true;         //
            if (Input.GetKeyUp(ActionInput))                    //
                movementController.Input_Action = false;        //
#endif
